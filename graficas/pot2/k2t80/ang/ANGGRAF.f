        PROGRAM ANGGRAF
            ...
            OPEN(UNIT=103,FILE='r3k2.dat',STATUS='unknown') 
            OPEN(UNIT=105,FILE='r5k2.dat',STATUS='unknown') !para SS

            OPEN(UNIT=104,FILE='r4k2.dat',STATUS='unknown') !para TT
            OPEN(UNIT=106,FILE='r6k2.dat',STATUS='unknown')
