        PROGRAM TESTGRAF
            ...
            OPEN(UNIT=101, FILE='outSSk5.dat', STATUS='unknown')
            OPEN(UNIT=102, FILE='outSTk5.dat', STATUS='unknown')
            OPEN(UNIT=103, FILE='outTTk5.dat', STATUS='unknown')
