        PROGRAM ANGGRAF
            ...
            OPEN(UNIT=103,FILE='r3-2-80.dat',STATUS='unknown') 
            OPEN(UNIT=105,FILE='r5-2-80.dat',STATUS='unknown') !para SS

            OPEN(UNIT=104,FILE='r4-2-80.dat',STATUS='unknown') !para TT
            OPEN(UNIT=106,FILE='r6-2-80.dat',STATUS='unknown')
